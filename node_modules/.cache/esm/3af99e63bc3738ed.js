let BeginnersWish,EpitomeInvocation,WanderlustInvocation,GentryOfHermitage;_bc3‍.w("../src/models/beginners-wish",[["default",["BeginnersWish"],function(v){BeginnersWish=v}]]);_bc3‍.w("../src/models/epitome-invocation",[["default",["EpitomeInvocation"],function(v){EpitomeInvocation=v}]]);_bc3‍.w("../src/models/wanderlust-invocation",[["default",["WanderlustInvocation"],function(v){WanderlustInvocation=v}]]);_bc3‍.w("../src/models/gentry-of-hermitage",[["default",["GentryOfHermitage"],function(v){GentryOfHermitage=v}]]);const chai = require('chai')
const fs = require('fs')
